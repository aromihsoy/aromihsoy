...
Backend-разработчик с опытом в IT-инфраструктуре — системном администрировании, сетях и поддержке. Этот фон помогает видеть не только код, но и то, как приложение живёт на сервере: как разворачивается, где упирается в ресурсы и что отказывает в проде.
